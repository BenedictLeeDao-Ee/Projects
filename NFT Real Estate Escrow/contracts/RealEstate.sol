...
using Counters for Counters.Counter;
    ...
    // Storing the metadata of the NFT in ipfs
    // List the NFT on zillow where you can post images and have the data of the real estate be shown
    constructor() ERC721("Real Estate", "REAL") {
        mint("https://ipfs.io/ipfs/QmTudSYeM7mz3PkYEWXWqPjomRPHogcMFSq7XAvsvsgAPS");
    }

    // Mints a new NFT from scratch
    // Collection starts from 0, add NFTs through mint
