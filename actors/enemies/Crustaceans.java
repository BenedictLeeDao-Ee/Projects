 ...
 *
 */
public abstract class Crustaceans extends Enemy {
     ...
     */
    public Crustaceans(String name, char displayChar, int hitPoints, int runes) {
    ...
    /**
     * The Crustacean can be attacked by any actor that has the HOSTILE_TO_CRUSTACEAN capability
     *
    ...
    public ActionList allowableActions(Actor otherActor, String direction, GameMap map) {
        ActionList actions = super.allowableActions(otherActor, direction, map);
         if (otherActor.hasCapability(Status.HOSTILE_TO_CRUSTACEAN)) {
